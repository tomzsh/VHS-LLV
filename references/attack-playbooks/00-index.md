# Attack Playbooks — 总目录

> Ported from `zhaoxuya520/reverse-skill` (`skills/pentest-tools/src-hunter/references/playbooks/`),
> MIT License (c) 2026 zhaoxuya520. Content kept verbatim (Chinese-language hunting
> methodology with English payloads/PoC). Use as P3/P4 test-design and validation
> guidance inside an authorized vhs engagement — hypotheses still need evidence-ledger
> validation per `references/p4-validation.md`.
...
| 🟡 P2 | `dos.md` | 应用层 DoS / 正则灾难 / 资源耗尽 / 放大攻击 |
| ⚫ 后渗透 | `intranet-postexp.md` | 触发后横向：内网探测 / 提权 / 凭据抓取（仅授权范围内）|
