...
| P3 test design | `p3-test-design.md`, `attack-playbooks/00-index.md`, `critical-review-loop.md` when sharpening a hypothesis, `dig-deeper-chain.md` only when a credible signal needs a follow-up hop, then only the selected playbook(s) |
| P4 validation | `p4-validation.md`, `evidence-standard.md`, `critical-review-loop.md`, `dig-deeper-chain.md` for an active investigation chain, `pivot-ladder.md` for an authorized cross-asset path, then the selected playbook(s) |
| P5 triage | `p5-triage.md`, `taxonomy-rating.md`, `critical-review-loop.md`, `pivot-ladder.md` when evaluating a cross-asset path, and the applicable judging/CVSS references |
